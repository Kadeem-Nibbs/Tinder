...
# kwargs are age_filter_min, age_filter_max, gender, distance_filter
# one or more of kwargs can be given in any order
# changes to tinder profile take effect after logging out then back in
